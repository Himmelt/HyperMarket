...
public class GuiMailBox extends EasyGui {
    private static ItemStack next/*上一页*/, sp/*分割*/, pre;/*下一页*/
    ...
    private void refreashBar() {
        ...
        Tools.setItemStack(fnext, null, Collections.singletonList("§9" + MarketConfig.translate("Now Page Is") + " §6§l[" + pageNow + " §6/ §l" + pageMax + "]"));
        Tools.setItemStack(fpre, null, Collections.singletonList("§9" + MarketConfig.translate("Now Page Is") + " §6§l[" + pageNow + " §6/ §l" + pageMax + "]"));
